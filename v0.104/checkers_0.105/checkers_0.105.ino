...
//0.105 re-writes the move piece function. It currently works off massive if statements. I want it to be a little easier to work with.
...
//currently considering re-writing this function to simplify the if statements. its getting pretty cluttered.
...
void movePiece(int row, int col) {
  ...
  if (checkerBoard[row][col] != 3 && checkerBoard[row][col] != 1 && checkerBoard[row + 1][col - 1] == player && col == add_col && row == row_right && player == 1 && player != 2 && checkerBoard[row][col] != 2 && checkerBoard[row + 1][col - 1] != 0 || checkerBoard[row + 1][col - 1] == 3 && checkerBoard[row][col] == 0) {
    Serial.println("P1 moved right");
    if(checkerBoard[row + 1][col - 1] == 1){
    ...
    col = 0;
    gameMoves++;
  } else if (checkerBoard[row][col] != 3 && checkerBoard[row][col] != 1 && checkerBoard[row - 1][col - 1] == player && col == add_col && row == row_left && player == 1 && player != 2 && checkerBoard[row][col] != 2 && checkerBoard[row - 1][col - 1] != 0 || checkerBoard[row - 1][col - 1] == 3 && checkerBoard[row][col] == 0) {
  ...
  //king piece move if conditionals for p1
  else if(checkerBoard[row][col] != 3 && checkerBoard[row][col] != 1 && checkerBoard[row + 1][col + 1] == 3 && player == 1 && player != 2 && col == add_col - 2 && row == row_right && checkerBoard[row][col] != 1 && checkerBoard[row + 1][col + 1] != 0 && checkerBoard[row][col] == 0){
    ...
    col = 0;
    gameMoves++;
  }else if(checkerBoard[row][col] != 3 && checkerBoard[row][col] != 1 && checkerBoard[row - 1][col + 1] == 3 && player == 1 && player != 2 && col == add_col - 2 && row == row_left && checkerBoard[row][col] != 1 && checkerBoard[row - 1][col + 1] != 0 && checkerBoard[row][col] == 0){
  ...
  if (checkerBoard[row][col] != 2 && checkerBoard[row][col] != 2 && checkerBoard[row - 1][col + 1] == player && player == 2 && player != 1 && col == add_col - 2 && row == row_left && checkerBoard[row][col] != 1 && checkerBoard[row - 1][col + 1] != 0 || checkerBoard[row - 1][col + 1] == 4) {
    Serial.println("P2 moved right");
    if(checkerBoard[row - 1][col + 1] == 2){
    checkerBoard[row - 1][col + 1] = 0;
    ...
    col = 0;
    gameMoves++;
  } else if (checkerBoard[row][col] != 2 && checkerBoard[row][col] != 2 && checkerBoard[row + 1][col + 1] == player && player == 2 && player != 1 && col == add_col - 2 && row == row_right && checkerBoard[row][col] != 1 && checkerBoard[row + 1][col + 1] != 0 || checkerBoard[row + 1][col + 1] == 4) {
  ...
  //start of p2 king movement if conditionals
  else if(checkerBoard[row][col] != 4 && checkerBoard[row][col] != 2 && checkerBoard[row + 1][col - 1] == 4 && col == add_col && row == row_right && player == 2 && checkerBoard[row][col] != 2 && checkerBoard[row + 1][col - 1] != 0 && checkerBoard[row][col] != 1) {
    ...
    col = 0;
    gameMoves++;
  }else if(checkerBoard[row][col] != 4 && checkerBoard[row][col] != 2 && checkerBoard[row - 1][col - 1] == 4 && col == add_col && row == row_left && player == 2 && checkerBoard[row][col] != 2 && checkerBoard[row - 1][col - 1] != 0 && checkerBoard[row][col] != 1) {
...
void checkWinner(){
  ...
  for(int i = 0; i <= 7; i++){
    for(int j = 0; j <= 7; j++){
      tile_value = checkerBoard[i][j];
      if(tile_value == 1 || tile_value == 3){
        player1++;
      }else if(tile_value == 2 || tile_value == 4){
        player2++;
      }
    }
  }
  if(player1 == 0){
    Serial.print("----------------------------------");
    Serial.print("Player 2 wins the game!");
    Serial.println("----------------------------------");
    tft.fillScreen(RED);
  } else if(player2 == 0){
    Serial.print("----------------------------------");
    Serial.print("Player 1 wins the game!");
    Serial.println("----------------------------------");
    tft.fillScreen(BLUE);
  }
}
