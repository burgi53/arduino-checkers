...
void movePiece(int row, int col) {
  ...
  if (checkerBoard[row][col] != 3 && checkerBoard[row][col] != 1 && checkerBoard[row + 1][col - 1] == player && col == add_col && row == row_right && player == 1 && checkerBoard[row][col] != 2 && checkerBoard[row + 1][col - 1] != 0 || checkerBoard[row + 1][col - 1] == 3 && checkerBoard[row][col] == 0) {
    ...
    col = 0;
    gameMoves++;
  } else if (checkerBoard[row][col] != 3 && checkerBoard[row][col] != 1 && checkerBoard[row - 1][col - 1] == player && col == add_col && row == row_left && player == 1 && checkerBoard[row][col] != 2 && checkerBoard[row - 1][col - 1] != 0 || checkerBoard[row - 1][col - 1] == 3 && checkerBoard[row][col] == 0) {
  ...
  //king piece move if conditionals for p1
  else if(checkerBoard[row][col] != 3 && checkerBoard[row][col] != 1 && checkerBoard[row + 1][col + 1] == 3 && player == 1 && col == add_col - 2 && row == row_right && checkerBoard[row][col] != 1 && checkerBoard[row + 1][col + 1] != 0 && checkerBoard[row][col] == 0){
    ...
    col = 0;
    gameMoves++;
  }else if(checkerBoard[row][col] != 3 && checkerBoard[row][col] != 1 && checkerBoard[row - 1][col + 1] == 3 && player == 1 && col == add_col - 2 && row == row_left && checkerBoard[row][col] != 1 && checkerBoard[row - 1][col + 1] != 0 && checkerBoard[row][col] == 0){
  ...
  if (checkerBoard[row][col] != 2 && checkerBoard[row][col] != 2 && checkerBoard[row - 1][col + 1] == player && player == 2 && col == add_col - 2 && row == row_left && checkerBoard[row][col] != 1 && checkerBoard[row - 1][col + 1] != 0 || checkerBoard[row - 1][col + 1] == 4) {
    Serial.println("P2 moved right");
    if(checkerBoard[row - 1][col + 1] == player){
    checkerBoard[row - 1][col + 1] = 0;
    ...
    col = 0;
    gameMoves++;
  } else if (checkerBoard[row][col] != 2 && checkerBoard[row][col] != 2 && checkerBoard[row + 1][col + 1] == player && player == 2 && col == add_col - 2 && row == row_right && checkerBoard[row][col] != 1 && checkerBoard[row + 1][col + 1] != 0 || checkerBoard[row + 1][col + 1] == 4) {
  ...
  //start of p2 king movement if conditionals
  else if(checkerBoard[row][col] != 2 && checkerBoard[row][col] != 2 && checkerBoard[row + 1][col - 1] == 4 && col == add_col && row == row_right && player == 2 && checkerBoard[row][col] != 2 && checkerBoard[row + 1][col - 1] != 0 && checkerBoard[row][col] != 1) {
    ...
    col = 0;
    gameMoves++;
  }else if(checkerBoard[row][col] != 2 && checkerBoard[row][col] != 2 && checkerBoard[row - 1][col - 1] == 4 && col == add_col && row == row_left && player == 2 && checkerBoard[row][col] != 2 && checkerBoard[row - 1][col - 1] != 0 && checkerBoard[row][col] != 1) {
