...
void movePiece(int row, int col) {
  ...
  if (checkerBoard[row + 1][col - 1] == player && col == add_col && row == row_right && player == 1 && checkerBoard[row][col] != 2 && checkerBoard[row + 1][col - 1] != 0 || checkerBoard[row + 1][col - 1] == 3 && checkerBoard[row][col] != 1) {
    ...
    col = 0;
    gameMoves++;
  } else if (checkerBoard[row - 1][col - 1] == player && col == add_col && row == row_left && player == 1 && checkerBoard[row][col] != 2 && checkerBoard[row - 1][col - 1] != 0 || checkerBoard[row - 1][col - 1] == 3 && checkerBoard[row][col] != 1) {
