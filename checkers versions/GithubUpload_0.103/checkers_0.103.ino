      ...
      for (int16_t i = 0; i <= 7; i++) {
        for (int16_t j = 0; j <= 7; j++) {
          ...
          if (currentTile == player && left1 == 2 && left2 == 0 && (j + 2) <= 7) {
            canEatL = true;
            Serial.print("canEatL: ");
            Serial.println(canEatL);
          ...
          if (currentTile == player && right1 == 2 && right2 == 0 && (j - 2) >= 0) {
            Serial.println("player 1 can jump right");
            canEatR = true;
            for (int16_t x = 0; x <= 1; x++) {
              switch (x) {
                case 0:
...
//          Serial.print("case 2_i: ");
//          Serial.println(i);
//          Serial.print("case 2_j: ");
//          Serial.println(j);
          // Serial.println(i);
          currentTile = checkerBoard[i][j];
          if((i-1) >= 0 && (j-1) >= 0){
          ...
          if (currentTile == player && right1 == 1 && right2 == 0 && (j + 2) <= 7) {
            Serial.println("im true for no fucking reason");
            canEatR = true;
            for (int16_t x = 0; x <= 1; x++) {
              switch (x) {
                case 0:
